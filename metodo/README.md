# Capa método (playbook interno)

El *cómo* se ejecuta la Metodología SOE. Audiencia: el asesor. Proceso detallado,
técnicas, plantillas y criterios de decisión.
...
> El *qué* y el *porqué* viven en [../publico/](../publico/).
